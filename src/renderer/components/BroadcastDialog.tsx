  ...
  return (
    <div data-testid="broadcast-dialog" onClick={() => setOpen(false)}
      ...
      <div onClick={e => e.stopPropagation()}
        style={{ background: 'var(--elevated, #252526)', color: 'var(--fg, #eee)', border: '1px solid var(--border, #444)', borderRadius: 6, padding: 12, width: 460, display: 'flex', flexDirection: 'column', gap: 8 }}>
